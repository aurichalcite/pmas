...
class TestAssertionFailure:
    ...
    def test_assertion_failure_string_representation(self):
        ...
        assert "test.py:10" in failure_str
    ...
    def test_assertion_failure_without_expected_actual(self):
        ...
        assert "test.py:20" in failure_str
...
class TestSoftAssertions:
    ...
    def test_context_manager_exit_with_failures_raises_assertion_error(self):
        ...
        assert "2 failure(s)" in error_message
    ...
    def test_assert_in_failure(self):
        ...
        assert failure.expected == "10 to be in [1, 2, 3]"
    ...
    def test_assert_not_in_success(self):
        ...
        with SoftAssertions() as soft:
            ...
            soft.assert_not_in("xyz", "hello world", "Substring should not be in string")
    ...
    def test_assert_greater_failure(self):
        ...
        assert failure.expected == "5 > 10"
        assert failure.actual == "5 <= 10"
    ...
    def test_multiple_failures_collected(self):
        ...
        error_message = str(exc_info.value)
        assert "3 failure(s)" in error_message
    ...
    @pytest.mark.parametrize("values,expected_failures", [
        ...
        try:
            with soft:
                for actual, expected in values:
                    soft.assert_equal(actual, expected, f"{actual} should equal {expected}")
